...
class Flutterwave
{
    ...
    /**
     * Issue Secret Key from your Flutterwave Dashboard
     * @var string
     */
    protected $secretKey;
    ...
    /**
     *  Response from requests made to Flutterwave
     * @var mixed
     */
    protected $response;
    ...
    /**
     * Authorization Url - Flutterwave payment page
     * @var string
     */
    ...
    {
        $this->baseUrl = env('FLUTTERWAVE_PAYMENT_URL');
    }

    /**
     * Get secret key from Flutterwave config file
     */
    ...
    public function makePaymentRequest( $data = null)
    {
        if ( $data == null ) {
            ...
            $data = [
                ...
                /*
                    Flutterwave allows for transactions to be split into a subaccount -
                ...
                */
                ...
                /*
                * to allow use of metadata on Flutterwave dashboard and a means to return additional data back to redirect url
     ...
     */
    public function verifyTransactionAtGateway($transactionRef)
    {
        $relativeUrl = "/transactions/{$transactionRef}/verify";
    ...
    /**
     * Fluent method to redirect to Flutterwave Payment Page
     */
    ...
    /**
     * Get all the plans that you have on Flutterwave
     * @return array
     */
    ...
    /**
     * Get all the subscriptions made on Flutterwave.
     *
     * @return array
     */
