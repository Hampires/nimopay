                            ...
                            <tbody>
                                <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($driver->created_at->format(env('DATETIME_DISPLAY_FORMAT','d M Y H:i'))); ?></td>
                                        <td class="text-right">
                                            <div class="dropdown">
...
<?php echo $__env->make('layouts.app', ['title' => __('Drivers')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\drivers\index.blade.php ENDPATH**/ ?>