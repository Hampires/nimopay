            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0"><?php echo e(__('settings.system_status')); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $testResutls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php else: ?>
                            <div class="card" style="width: 40rem;">
                                ...
                                <a href="<?php echo e($item[3]); ?>" class="btn btn-primary"><?php echo e(__('settings.how_to_fix_this')); ?></a>
                                </div>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-info">
                            ...
                            <span><?php echo e(__('settings.setup_progress')); ?></span>
                              </div>
...
<?php echo $__env->make('layouts.app', ['title' => __('settings.system_status')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\settings\status.blade.php ENDPATH**/ ?>