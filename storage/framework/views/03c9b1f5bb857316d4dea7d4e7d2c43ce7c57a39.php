                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                <?php if(auth()->user()->hasRole('admin') && env('ENABLE_IMPORT_CSV', true)): ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $restorants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restorant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($restorant->created_at->format(env('DATETIME_DISPLAY_FORMAT','d M Y H:i'))); ?></td>
                                        <td>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurants')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\restorants\index.blade.php ENDPATH**/ ?>