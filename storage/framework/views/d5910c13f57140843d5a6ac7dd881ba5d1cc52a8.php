<div class="card card-profile bg-secondary shadow">
    ...
    <div class="card-body">
        <form method="post" action="<?php echo e(route('business.workinghours')); ?>" autocomplete="off" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/restorants/partials/hours.blade.php ENDPATH**/ ?>