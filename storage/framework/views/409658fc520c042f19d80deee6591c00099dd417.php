...
<div class="row">
    ...
    <?php if(env('SUBSCRIPTION_PROCESSOR','Stripe')=='Paddle'): ?>
        <div class="col-md-6">
    ...
    <?php if(env('SUBSCRIPTION_PROCESSOR','Stripe')=='Stripe'): ?>
        <div class="col-md-6">
    ...
    <?php if(env('SUBSCRIPTION_PROCESSOR','Stripe')=='PayPal'): ?>
        <div class="col-md-6">
    ...
    <?php if(env('SUBSCRIPTION_PROCESSOR','Stripe')=='Mollie'): ?>
        <div class="col-md-6">
    ...
    <?php if(env('SUBSCRIPTION_PROCESSOR','Stripe')=='Paystack'): ?>
        <div class="col-md-6">
...
<?php /**PATH /home/walydqmf/dashboard.paulecapital.com/resources/views/plans/form.blade.php ENDPATH**/ ?>