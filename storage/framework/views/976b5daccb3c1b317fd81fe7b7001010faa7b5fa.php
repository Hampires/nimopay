    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 text-center">
                <!-- Button Modal -->
                <a href="<?php echo e(route('newbusiness.register')); ?>" class="btn btn-secondary animate-up-2"><span class="mr-2"><i class="fas fa-hand-pointer"></i></span><?php echo e(__('qrlanding.demo_button')); ?></a>
            </div>
        </div>
    </div>
</section>
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/qrsaas/partials/demo.blade.php ENDPATH**/ ?>