<div class="card card-profile shadow">
                ...
                <select name="addressID" id="addressID" class="form-control<?php echo e($errors->has('addressID') ? ' is-invalid' : ''); ?>  noselecttwo" required>
                    ...
                    <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(env('ENABLE_COST_PER_DISTANCE',false)): ?>
                            <option data-cost=<?php echo e($address->cost_per_km); ?> id="<?php echo e('address'.$address->id); ?>"  <?php if(!$address->inRadius){echo "disabled";} ?> value=<?php echo e($address->id); ?>><?php echo e($address->address." - ".money( $address->cost_per_km, env('CASHIER_CURRENCY','usd'),env('DO_CONVERTION',true))); ?> </option>
                        <?php else: ?>
  ...
  <br />
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\cart\address.blade.php ENDPATH**/ ?>