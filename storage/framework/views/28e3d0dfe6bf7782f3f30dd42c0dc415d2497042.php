<?php $__env->startSection('admin_title'); ?>
    <?php echo e(ucwords($enterprise->name) . __(' Management')); ?>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(ucwords($enterprise->name) . __(' Management')); ?></h3>
                            ...
                            <div class="col-4 text-right">
                                ...
                                <?php else: ?>
                                    <a target="_blank" href="<?php echo e(route('vendor',[$enterprise->name, $restorant->subdomain])); ?>" class="btn btn-sm btn-success"><?php echo e(__('View it')); ?></a>
                                <?php endif; ?>
                    ...
                    <div class="card-body">
                       <h6 class="heading-small text-muted mb-4"><?php echo e(ucwords($enterprise->name) . __(' information')); ?></h6>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/restorants/edit.blade.php ENDPATH**/ ?>