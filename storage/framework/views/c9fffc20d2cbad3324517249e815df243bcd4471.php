    ...
    <div class="card shadow-soft mb-5 mb-lg-6 px-2">
        <div class="card-header border-light py-5 px-4">
            ...
            <div class="d-flex mb-3 text-primary">
                <span class="h5 mb-0"> <?php echo e(env('CASHIER_CURRENCY','usd')); ?></span>
        ...
        <div class="card-footer px-4 pb-4">
            <!-- Button -->
            <a href="<?php echo e(route('newbusiness.register')); ?>" class="btn btn-block btn-outline-gray animate-up-2">
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/qrsaas/partials/plan.blade.php ENDPATH**/ ?>