<div class="card card-profile shadow mt--300">
    <div class="px-4">
      ...
      <div  class="border-top">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <!-- Flutterwave -->
                        <?php if(env('ENABLE_FLUTTERWAVE', false)): ?>
                            <div class="custom-control custom-radio mb-3">
                                <input name="paymentType" class="custom-control-input" id="paymentFlutterwave" type="radio" value="flutterwave" <?php echo e(env('DEFAULT_PAYMENT','cod')=="flutterwave"?"checked":""); ?>>
                                <label class="custom-control-label" for="paymentFlutterwave"><?php echo e(__('Pay with Flutterwave')); ?></label>
                            </div>
                        <?php endif; ?>
        ...
        <?php if(!env('IS_WHATSAPP_ORDERING_MODE',false) && !env('WHATSAPP_ORDERING_ENABLED',false) && !env('ENABLE_FACEBOOK_ORDERING',false) && !env('IS_FACEBOOK_ORDERING_MODE',false)): ?>
            ...
            <!-- Flutterwave -->
            <?php if(env('ENABLE_FLUTTERWAVE',false)): ?>
                <?php echo $__env->make('cart.payments.flutterwave', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
  ...
  <?php endif; ?>
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/cart/payment.blade.php ENDPATH**/ ?>