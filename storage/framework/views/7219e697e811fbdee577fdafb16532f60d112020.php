            ...
            <div class="col-lg-5 col-md-7">
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <?php if(config('app.isft')&&(strlen(env('GOOGLE_CLIENT_ID',""))>3||strlen(env('FACEBOOK_CLIENT_ID',""))>3)): ?>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\auth\login.blade.php ENDPATH**/ ?>