            ...
            <div class="timeline-content">
                <div class="d-flex justify-content-between pt-1">
                    ...
                    <div class="text-right">
                        <small class="text-muted"><i class="fas fa-clock mr-1"></i><?php echo e($stakeholder->pivot->created_at->format(env('DATETIME_DISPLAY_FORMAT','d M Y H:i'))); ?></small>
                    </div>
                </div>
...
</div><?php /**PATH /home/walydqmf/dashboard.paulecapital.com/resources/views/orders/partials/orderstatus.blade.php ENDPATH**/ ?>