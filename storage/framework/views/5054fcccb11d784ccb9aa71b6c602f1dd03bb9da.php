            ...
            <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="post" action="<?php echo e(route('import.businesses')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/restorants/partials/modals.blade.php ENDPATH**/ ?>