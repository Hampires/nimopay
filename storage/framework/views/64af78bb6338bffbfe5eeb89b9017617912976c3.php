...
<body class="font-sans text-gray-600 bg-gray-200 leading-normal p-4 h-full">
        ...
        <div class="w-full max-w-lg">
            ...
            <div class="bg-white rounded-lg shadow-xl p-4 sm:py-6 sm:px-10 mb-5">
                <?php if($payment->isSucceeded()): ?>
                    ...
                    <p class="mb-6"><?php echo e(__('This payment was already successfully confirmed.')); ?></p>
                ...
                <?php else: ?>
                    <div id="payment-elements" v-if="! paymentProcessed">
                        ...
                        <!-- Name -->
                        <label for="cardholder-name" class="inline-block text-sm text-gray-700 font-semibold mb-2"><?php echo e(__('Full name')); ?></label>

                        <input id="cardholder-name" type="text" placeholder="<?php echo e(__('Jane Doe')); ?>" required
                               class="inline-block bg-gray-200 border border-gray-400 rounded-lg w-full px-4 py-3 mb-3 focus:outline-none"
                               v-model="name">

                        <!-- Card -->
                        <label for="card-element" class="inline-block text-sm text-gray-700 font-semibold mb-2"><?php echo e(__('Card')); ?></label>
                ...
                <a href="<?php echo e($redirect ?? url('/')); ?>"
    ...
    <script>
        ...
        var app = new Vue({
            ...
            <?php if(! $payment->isSucceeded() && ! $payment->isCancelled()): ?>
                mounted: function () {
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\vendor\laravel\cashier\resources\views\payment.blade.php ENDPATH**/ ?>