...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('items.partials.header', ['title' => __('Edit ' . ucwords($enterprise->name) . ' Menu')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="mb-0"><?php echo e(__(ucwords($enterprise->name) . ' Menu Management')); ?></h3>
                                    </div>
                                    <div class="col-auto">
...
<?php echo $__env->make('layouts.app', ['title' => __(ucwords($enterprise->name) . ' Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/items/index.blade.php ENDPATH**/ ?>