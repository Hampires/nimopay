                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <?php if(env('ENABLE_BIRTH_DATE_ON_REGISTER',false)): ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($client->created_at->format(env('DATETIME_DISPLAY_FORMAT','d M Y H:i'))); ?></td>
                                        <?php if(env('ENABLE_BIRTH_DATE_ON_REGISTER',false)): ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Clients')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\clients\index.blade.php ENDPATH**/ ?>