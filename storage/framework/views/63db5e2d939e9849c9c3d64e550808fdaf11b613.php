        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-lg-0">
                ...
                <ul class="links-vertical">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                    <li><a target="_blank" href="<?php echo e(route('newbusiness.register')); ?>"><?php echo e(__('qrlanding.register')); ?></a></li>
                    <?php endif; ?>
                </ul>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <form action="<?php echo e(route('newbusiness.register')); ?>" class="d-flex flex-column mb-5 mb-lg-0">
        ...
        <div class="row">
            <div class="col pb-4 mb-md-0">
                <div class="d-flex text-center justify-content-center align-items-center">
                    <p class="font-weight-normal mb-0">© <a href="<?php echo e(env('APP_URL', 'http://localhost')); ?>"
                            target="_blank"><?php echo e(env('APP_NAME')); ?></a></a>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/qrsaas/partials/footer.blade.php ENDPATH**/ ?>