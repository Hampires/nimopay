<div class="pl-lg-4">
    <form method="post" action="<?php echo e(route('admin.businesses.update', $restorant)); ?>" autocomplete="off" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group<?php echo e($errors->has('enterprise') ? ' has-danger' : ''); ?>">
            ...
            <select class="w-100 form-control form-control-alternative   <?php if(isset($classselect)): ?> <?php echo e($classselect); ?> <?php endif; ?>"  name="enterprise" id="enterprise">
                <option disabled value> <?php echo e(__('Select')." ".__('Business Category')); ?> </option>
                <?php $__currentLoopData = $enterprises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enterprise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($enterprise->id == $restorant->enterprise_id): ?>
                        <option value="<?php echo e($enterprise->id); ?>" selected><?php echo e(__(ucwords($enterprise->name))); ?></option>
                    <?php else: ?>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/restorants/partials/info.blade.php ENDPATH**/ ?>