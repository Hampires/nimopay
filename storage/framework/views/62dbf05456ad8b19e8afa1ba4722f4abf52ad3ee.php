...
<?php $__env->stopSection(); ?>
<?php if(env('SHARE_THIS_PROPERTY',false)): ?>
    <?php $__env->startSection('head'); ?>
        <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=<?php echo e(env('SHARE_THIS_PROPERTY',"")); ?>&product=sticky-share-buttons" async="async"></script>
    <?php $__env->stopSection(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Share Menu')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\restorants\share.blade.php ENDPATH**/ ?>