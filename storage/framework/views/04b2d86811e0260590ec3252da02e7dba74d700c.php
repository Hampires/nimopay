<nav id="navbar-main" class="navbar navbar-main navbar-expand-lg headroom py-lg-3 px-lg-6 navbar-light navbar-theme-primary">
    <div class="container">
        ...
        <div class=" @cta_button_classes">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('newbusiness.register')); ?>" target="_blank" class="btn btn-md btn-secondary animate-up-2"><i class="fas fa-paper-plane mr-2"></i><?php echo e(__('qrlanding.register')); ?></a>
            <?php endif; ?>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/qrsaas/partials/nav.blade.php ENDPATH**/ ?>