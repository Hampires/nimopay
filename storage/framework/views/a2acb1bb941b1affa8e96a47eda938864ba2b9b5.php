      ...
      <div class="row align-items-center justify-content-md-between">
        ...
        <div class="col-md-6">
          <ul id="footer-pages" class="nav nav-footer justify-content-end">
            ...
            <li class="nav-item">
              <a  target="_blank" class="button nav-link nav-link-icon" href="<?php echo e(route('newbusiness.register')); ?>"><?php echo e(__(env('RESTAURANT_LINK_REGISTER_TITLE',"Register your restaurant"))); ?></a>
            </li>
          <?php endif; ?>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/layouts/footers/front.blade.php ENDPATH**/ ?>