                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="uppercase font-thin"><?php echo e(env('APP_LOCALE',"EN")); ?></th>
                            ...
                            <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $translations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(json_encode($value[strtolower(env('APP_LOCALE',"EN"))])); ?></td>
                                        <td>
                                            <translation-input
...
<?php echo $__env->make('translation::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\vendor\translation\languages\translations\index.blade.php ENDPATH**/ ?>