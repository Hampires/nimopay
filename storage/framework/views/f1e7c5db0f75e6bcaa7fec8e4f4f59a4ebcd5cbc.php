<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <?php if(env('RESTOLOYALTY_TOKEN',null)): ?>
            <?php if(auth()->check() && auth()->user()->hasRole('admin')): ?>
                <hr class="my-3">
                <h6 class="navbar-heading text-muted"><?php echo e(__('External plugins')); ?></h6>
                <ul class="navbar-nav">
                    <li class="nav-item">
                    <a class="nav-link" href="https://app.restoloyalty.com/sso/<?php echo e(env('RESTOLOYALTY_TOKEN','')); ?>">
        ...
        $(document).ready(function() { 
            setTimeout(function(){ 
                ...
                success: function(response) {
                    if(response != ''){
                        $('#update_notification').append('<strong>New Update<br /><br /><span class="badge badge-pill badge-info">v. '+response+'</span></strong><br /><br /><a role="button" href="updater.update" class="btn btn-sm btn-info pull-right">Update Now</a>');
...
<?php endif; ?>
<?php /**PATH /home/walydqmf/dashboard.paulecapital.com/resources/views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>