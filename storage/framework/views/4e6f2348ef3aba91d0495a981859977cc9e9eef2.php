<div class="row">
    ...
    <div class="col-md-3">
        <?php if(isset($coupon) && $coupon->type == 0): ?>
            <?php echo $__env->make('partials.input',['class'=>"col-12", 'type'=>'number', 'name'=>"Price",'id'=>"price_fixed",'placeholder'=>"Enter price here",'required'=>false, 'additionalInfo'=>'Price in '.env('CASHIER_CURRENCY','usd'), 'value'=>$coupon->price], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('partials.input',['class'=>"col-12", 'type'=>'number', 'name'=>"Price",'id'=>"price_fixed",'placeholder'=>"Enter price here",'required'=>false, 'additionalInfo'=>'Price in '.env('CASHIER_CURRENCY','usd'), 'value'=>$coupon->price], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('partials.input',['class'=>"col-12", 'type'=>'number', 'min'=>'1', 'max'=>'100', 'name'=>"Price",'id'=>"price_percentage",'placeholder'=>"Enter percentage here",'required'=>false, 'additionalInfo'=>'Percentage value','value'=>$coupon->price], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('partials.input',['class'=>"col-12", 'type'=>'number', 'name'=>"Price",'id'=>"price_fixed",'placeholder'=>"Enter price here",'required'=>false, 'additionalInfo'=>'Price in '.env('CASHIER_CURRENCY','usd')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\coupons\form.blade.php ENDPATH**/ ?>