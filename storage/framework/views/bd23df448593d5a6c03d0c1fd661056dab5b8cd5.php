  ...
  <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbar_global">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          <?php if(!env('SINGLE_MODE',false)&&env('RESTAURANT_LINK_REGISTER_POSITION','footer')=="navbar"): ?>
            <li class="nav-item">
              <a data-mode="popup" target="_blank" class="button nav-link nav-link-icon" href="<?php echo e(route('newrestaurant.register')); ?>"><?php echo e(__(env('RESTAURANT_LINK_REGISTER_TITLE',"Register your restaurant"))); ?></a>
            </li>
          <?php endif; ?>
          <?php if(config('app.isft')&&env('DRIVER_LINK_REGISTER_POSITION','footer')=="navbar"): ?>
          <li class="nav-item">
              <a data-mode="popup" target="_blank" class="button nav-link nav-link-icon" href="<?php echo e(route('driver.register')); ?>"><?php echo e(__(env('DRIVER_LINK_REGISTER_TITLE',"Register your restaurant"))); ?></a>
            </li>
            <?php endif; ?>
          <li class="nav-item">
...
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views\layouts\menu\top.blade.php ENDPATH**/ ?>