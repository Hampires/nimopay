<div class="col-12 col-md-6 col-lg-4 mb-5">
    <div class="card shadow-soft border-light">
        ...
        <i class="fas fa-edit mr-2 text-primary ckedit_btn" type="button" style="display: none"></i> <p class="card-text ckedit" <?php {echo 'id='.$subtitle['key']; }?> <?php {echo 'key='.$subtitle['key']; }?> ><?php echo e($subtitle['value']); ?></p>
            ...
            <a href="<?php echo e(route('newbusiness.register')); ?>" class="btn btn-primary"><?php echo e($button_name); ?></a>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\pc\Documents\Laravel[WORKSPACE]\nimopay\resources\views/qrsaas/partials/product_items.blade.php ENDPATH**/ ?>