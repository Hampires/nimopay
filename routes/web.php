...
Route::group(['middleware' => ['auth'] ], function () {
    ...
    Route::name('admin.')->group(function () {
        Route::resource('businesses', 'RestorantController');

        Route::get('businesses/loginas/{business}', 'RestorantController@loginas')->name('businesses.loginas');

        Route::get('removedemodata','RestorantController@removedemo')->name('businesses.removedemo');
        Route::name('business.')->group(function () {

            //Remove business
            Route::get('removebusiness/{business}','RestorantController@remove')->name('remove');

            // Tables / Placeholder
            Route::get('placeholders', 'TablesController@index')->name('tables.index');
            Route::get('placeholders/{table}/edit', 'TablesController@edit')->name('tables.edit');
            Route::get('placeholders/create', 'TablesController@create')->name('tables.create');
            Route::post('placeholders', 'TablesController@store')->name('tables.store');
            Route::put('placeholders/{table}', 'TablesController@update')->name('tables.update');
            Route::get('placeholders/del/{table}', 'TablesController@destroy')->name('tables.delete');
    ...
    Route::post('/updateres/location/{business}', 'RestorantController@updateLocation');
    Route::post('/updateres/radius/{business}', 'RestorantController@updateRadius');
    Route::post('/updateres/delivery/{business}', 'RestorantController@updateDeliveryArea');
    Route::post('/import/businesses', 'RestorantController@import')->name('import.businesses');
    Route::get('/business/{business}/activate', 'RestorantController@activatebusiness')->name('business.activate');
    Route::post('/business/workinghours', 'RestorantController@workingHours')->name('business.workinghours');
    ...
    Route::get('businesseslocations', 'RestorantController@businesseslocations');
    ...
    Route::post('/plan/price', 'PlansController@price')->name('plans.price');
    ...
    Route::prefix('bank')->name('bank.')->group(function () {
        Route::post('/detail/connect', 'BanksController@detail_edit')->name('connect');
    });
...
Route::get('/get/rlocation/{business}', 'RestorantController@getLocation');
...
Route::get('/new/business/register', 'RestorantController@showRegisterRestaurant')->name('newbusiness.register');
Route::post('/new/business/register/store', 'RestorantController@storeRegisterRestaurant')->name('newbusiness.store');
...
Route::get('register/visit/{business_id}', 'VisitsController@register')->name('register.visit');
...
Route::get('/' . '{enterprise}' . '/{alias}', 'FrontEndController@restorant')->name('vendor');