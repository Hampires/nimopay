    ...
    <div class="px-4">
      ...
      <div  class="border-top">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <!-- Flutterwave -->
                        @if(env('ENABLE_FLUTTERWAVE', false))
                            <div class="custom-control custom-radio mb-3">
                                <input name="paymentType" class="custom-control-input" id="paymentFlutterwave" type="radio" value="flutterwave" {{ env('DEFAULT_PAYMENT','cod')=="flutterwave"?"checked":""}}>
                                <label class="custom-control-label" for="paymentFlutterwave">{{ __('Pay with Flutterwave') }}</label>
                            </div>
                        @endif
        ...
        @if(!env('IS_WHATSAPP_ORDERING_MODE',false) && !env('WHATSAPP_ORDERING_ENABLED',false) && !env('ENABLE_FACEBOOK_ORDERING',false) && !env('IS_FACEBOOK_ORDERING_MODE',false))
            ...
            <!-- Flutterwave -->
            @if(env('ENABLE_FLUTTERWAVE',false))
                @include('cart.payments.flutterwave')
            @endif
