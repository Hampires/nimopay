<ul class="navbar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.businesses.edit',  auth()->user()->restorant->id) }}">
            <i class="ni ni-shop text-info"></i> {{ __('Business') }}
        </a>
    </li>
    <li class="nav-item">
    ...
    @if (config('app.isqrsaas') && (!env('QRSAAS_DISABLE_ODERING',false) || env('ENABLE_GUEST_LOG',true)))
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.business.tables.index') }}">
                <i class="ni ni-ungroup text-red"></i> Manage {{ __(ucwords(auth()->user()->restorant->placeholder . 's')) }}
            </a>
        </li>
    @endif
    ...
    @if (config('app.isqrsaas'))
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.business.visits.index') }}">
    ...
    @endif
        ...
        <!--
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.business.coupons.index') }}">
