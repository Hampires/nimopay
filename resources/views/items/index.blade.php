@extends('layouts.app', ['title' => __(ucwords($enterprise->name) . ' Menu Management')])
@section('admin_title')
    {{__('Menu')}}
@endsection
@section('content')
    @include('items.partials.modals')
    @include('items.partials.header', ['title' => __('Edit ' . ucwords($enterprise->name) . ' Menu')])
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="mb-0">{{ __(ucwords($enterprise->name) . ' Menu Management') }}</h3>
                                    </div>
                                    <div class="col-auto">
                                            ...
                                            <a href="{{ route('items.edit', $item) }}">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <span class="badge badge-primary badge-pill">@money($item->price, env('CASHIER_CURRENCY','usd'),env('DO_CONVERTION',true))</span>
