        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-lg-0">
                ...
                <ul class="links-vertical">
                    ...
                    @guest()
                    <li><a target="_blank" href="{{ route('newbusiness.register') }}">{{ __('qrlanding.register') }}</a></li>
                    @endguest
                </ul>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                    @guest()
                        ...
                        <form action="{{ route('newbusiness.register') }}" class="d-flex flex-column mb-5 mb-lg-0">
        ...
        <div class="row">
            <div class="col pb-4 mb-md-0">
                <div class="d-flex text-center justify-content-center align-items-center">
                    <p class="font-weight-normal mb-0">© <a href="{{ env('APP_URL', 'http://localhost') }}"
                            target="_blank">{{  env('APP_NAME') }}</a></a>
